<template>
	<view class="page">
		<CustomTop top_title="添加地址"></CustomTop>
		<view class="address_create">
            ...
            <view class="aduty-form-cell-box">
              ...
              <view class="aduty-form-cell-bd">
                <input name="name" class="aduty-form-input" type="text" value="" placeholder="请输入联系人姓名" />
              </view>
            </view>
				  </view>
					<view class="aduty-form-cell">
            <view class="aduty-form-cell-box">
              ...
              <view class="aduty-form-cell-bd">
                <input name="phone" class="aduty-form-input" type="text" value="" placeholder="请输入联系人电话" />
              </view>
            </view>
					</view>
					<view class="aduty-form-cell">
            ...
            <view class="aduty-form-cell-box">
              ...
              <view class="aduty-form-cell-bd">
                <input name="detailed_address" class="aduty-form-input" type="text" value="" placeholder="请输入详细地址" />
              </view>
            </view>
					</view>
				</view>
...
export default {
	...
	methods: {
		formSubmit: function(e) {
			...
			request.post('/address/store', params).then(res => {
				uni.hideLoading();
				if (res.code == 200) {
					this.result = true;
