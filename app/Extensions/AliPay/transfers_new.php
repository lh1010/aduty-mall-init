...
namespace App\Extensions\AliPay;

class transfers_new
{
    protected $appId;
    protected $rsaPrivateKey;
    protected $appCertSn = 'D:\WWW\My\aduty-cmf\public\alipay\appCertPublicKey_2021003118692091.txt';   // 应用公钥证书
    protected $alipayRootCertSn = 'D:\WWW\My\aduty-cmf\public\alipay\alipayRootCert.crt'; // 支付宝根证书
