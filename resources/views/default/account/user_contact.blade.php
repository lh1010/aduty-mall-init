...
@section('title', '联系方式 ' . Config('common.pc.app_name'))
@section('content')
        ...
        <form class="layui-form" autocomplete="off">
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="weixin" class="layui-input" value="{{isset($user_contact->weixin) ? $user_contact->weixin : ''}}" >
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">手机</label>
            <div class="layui-input-block">
              <input type="text" name="phone" class="layui-input" value="{{isset($user_contact->phone) ? $user_contact->phone : ''}}" >
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">Q Q</label>
            <div class="layui-input-block">
              <input type="text" name="qq" class="layui-input" value="{{isset($user_contact->qq) ? $user_contact->qq : ''}}" >
            </div>
          </div>
          <div class="layui-form-item">
            <label class="layui-form-label">电话</label>
            <div class="layui-input-block">
              <input type="text" name="telphone" class="layui-input" value="{{isset($user_contact->telphone) ? $user_contact->telphone : ''}}" >
            </div>
          </div>
          <div class="layui-form-item">
            <div class="layui-input-block">
...
layui.use('form', function() {
  ...
  form.on('submit(formSub)', function(data) {
    ...
    $.ajax({
      url: '/api/account/updateUserContact',
      type: 'post',
      data: data,
