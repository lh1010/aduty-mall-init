...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/auth/role_update" method="post" autocomplete="off">
    @csrf
    ...
    <div class="m-4 pagebox">
      <div class="row mb-3">
        ...
        <div class="col-8">
          <input class="form-control" name="name" value="{{$role->name}}" placeholder="">
        </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-auto">
          <select class="form-select" name="status">
            <option value="1" @if($role->status == 1) selected @endif>开启</option>
            <option value="0" @if($role->status == 0) selected @endif>关闭</option>
          </select>
        </div>
      </div>
    </div>
