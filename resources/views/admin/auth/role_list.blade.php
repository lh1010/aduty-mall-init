...
<div class="main">
  <div class="bg-white p-4">
    <div class="breadcrumb-stitle">角色管理</div>
  </div>
  <div class="mx-4 mt-4">
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/auth/role_create"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      <table class="table text-center mt-3">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/auth/role_edit?id={{$value->id}}">编辑</a>
              <a class="btn btn-danger btn-sm" href="javascript:void(0);" onclick="deleteAction({{$value->id}})">删除</a>
              <a class="btn btn-primary btn-sm" href="javascript:void(0);" onclick="layerOpen('/admin/auth/set_role_to_action?role_id={{$value->id}}', '权限分配', '70%', '95%');">权限</a>
            </td>
          </tr>
          @endforeach
        </tbody>
      </table>
      <div class="page my-3">{{ $roles->appends(Request()->all())->render() }}</div>
      @else
      <div class="noresult">
...
function deleteAction(id = '') {
  ...
  layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/auth/role_delete?id=' + id,
      dataType: 'json',
