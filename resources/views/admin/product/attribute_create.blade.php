...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/product/attribute_store" method="post" autocomplete="off">
    @csrf
    <div class="m-4 pagebox">
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end"><span class="text-danger">*</span> 属性名字：</label>
        <div class="col-8">
  ...
  submitHandler: function() {
    layer.confirm('确认提交？', function() {
      ...
      $("#form").ajaxSubmit(function(res) {
        layer.close(load);
        if (res.code == 200) {
          layer.msg('操作成功', { time: 1500 }, function () { window.location.href = '/admin/product/attribute_list?group_id={{Request()->group_id}}'; });
