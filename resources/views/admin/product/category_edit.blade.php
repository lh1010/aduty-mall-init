...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/product/category_update" method="post" autocomplete="off">
    @csrf
    ...
    <div class="m-4 pagebox">
      ...
      <div class="row mb-3">
        ...
        <div class="col-2">
          <input class="form-control" name="sort" value="{{$category->sort}}" placeholder="">
        </div>
      </div>
      <div class="row mb-3">
