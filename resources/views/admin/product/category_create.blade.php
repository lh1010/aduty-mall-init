...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/product/category_store" method="post" autocomplete="off">
    @csrf
  ...
  submitHandler: function() {
    layer.confirm('确认提交？', function() {
      ...
      $("#form").ajaxSubmit(function(res) {
        layer.close(load);
        if (res.code == 200) {
          layer.msg('操作成功', { time: 1500 }, function () { window.location.href = '/admin/product/category_list'; });
