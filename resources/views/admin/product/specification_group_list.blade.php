...
<div class="main">
  <div class="bg-white p-4">
    <div class="breadcrumb-stitle">商品规格组合</div>
  </div>
  <div class="m-4">
    <div class="pagebox">
      <form class="row g-2">
    ...
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/product/specification_group_create"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="options" onclick="layerOpen('/admin/product/specification_list?group_id={{$value->id}}', '商品规格');">
                @foreach($value->specifications as $value_specification)
                <span class="option">{{$value_specification->name}}</span>
                @endforeach
              </div>
              @endif
            </td>
            ...
            <td>
              <button type="button" class="btn btn-success btn-sm" onclick="layerOpen('/admin/product/specification_list?group_id={{$value->id}}', '商品规格');">商品规格</button>
              <a class="btn btn-primary btn-sm" href="/admin/product/specification_group_edit?id={{$value->id}}{{ encodePrevPageParams(); }}">编辑</a>
...
function deleteAction(id = '') {
  ...
  var layer_confirm = layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/product/specification_group_delete?id=' + id,
      dataType: 'json',
