...
<div class="main">
  <div class="bg-white p-4">
    ...
    <div class="mt-3" style="font-size: 12px;">所属模型：{{$attribute->name}}</div>
  </div>
  <div class="mx-4 mt-4">
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/product/attribute_option_create?attribute_id={{Request()->attribute_id}}"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      <table class="table text-center mt-3">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/product/attribute_option_edit?id={{$value->id}}&attribute_id={{Request()->attribute_id}}">编辑</a>
...
function deleteAction(id = '') {
  ...
  var layer_confirm = layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/product/attribute_option_delete?id=' + id,
      dataType: 'json',
