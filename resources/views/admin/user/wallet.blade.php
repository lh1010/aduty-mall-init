...
<div class="main p-4">
  <form class="" id="form" action="" method="post" autocomplete="off">
    ...
    <div class="row mb-3">
      <label class="col-2 col-form-label text-end">钱包余额：</label>
      <div class="col-auto">
    ...
    <div class="row mb-3">
      <label class="col-2 col-form-label text-end"><i class="iconfont iconfont-question" data-bs-toggle="tooltip" title="请输入金额"></i> 金额：</label>
      <div class="col-8">
  ...
  <div class="mt-4 px-3 pt-3" style="border-top: 1px solid #f5f5f5;">
    ...
    <table class="table text-center mt-3">
      ...
      <tbody>
        ...
        <tr>
          <td>{{$value->ident == 'inc' ? '+' : '-'}}{{$value->price}}</td>
