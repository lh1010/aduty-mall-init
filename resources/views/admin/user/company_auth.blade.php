...
<div class="main">
  <div class="pagebox m-3">
    ...
    <form class="mt-4" id="form" action="" method="post" autocomplete="off">
      ...
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end">企业名字：</label>
        <div class="col-auto">
          <div class="form-control-plaintext">{{$log->company_name}}</div>
        </div>
      </div>
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end">社会信用代码：</label>
        <div class="col-auto">
          <div class="form-control-plaintext">{{$log->social_credit_code}}</div>
        </div>
      </div>
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end">营业执照：</label>
        <div class="col-auto">
          <div class="form-control-plaintext">
            <a href="{{$log->business_license}}" target="_blank"><img src="{{$log->business_license}}" style="width: 80px; height: 80px; border-radius: 5px; border: 1px solid #f5f5f5; padding: 3px;"></a>
          </div>
        </div>
      </div>
      <div class="row mb-3">
    ...
    <table class="table mt-3" style="font-size: 12px;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$value->social_credit_code}}</td>
          <td>
            <a href="{{$value->business_license}}" target="_blank"><img src="{{$value->business_license}}" style="width: 65px; height: 65px; border-radius: 5px; border: 1px solid #f5f5f5; padding: 3px;"></a>
          </td>
          <td>{{Config('common.user.company_auth_status')[$value->status]}}</td>
