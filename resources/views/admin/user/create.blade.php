...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/user/store" method="post" autocomplete="off">
    @csrf
    <div class="m-4 pagebox">
      ...
      <div class="form-tab" id="b">
        <div class="row mb-3">
          ...
          <div class="col-4">
            <input class="form-control" name="contact[weixin]" value="" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-2 col-form-label text-end">手机：</label>
          <div class="col-4">
            <input class="form-control" name="contact[phone]" value="" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-2 col-form-label text-end">电话：</label>
          <div class="col-4">
            <input class="form-control" name="contact[telphone]" value="" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-2 col-form-label text-end">Q Q：</label>
          <div class="col-4">
            <input class="form-control" name="contact[qq]" value="" placeholder="">
          </div>
        </div>
      </div>
    </div>
  ...
  submitHandler: function() {
    layer.confirm('确认提交？', function() {
      ...
      $("#form").ajaxSubmit(function(res) {
        ...
        if (res.code == 200) {
          layer.msg('提交成功', { time: 1500 }, function () { window.location.href = '/admin/user/list'; });
