...
<div class="main">
  ...
  <form class="mt-4" id="form" action="/admin/cdkey/store" method="post" autocomplete="off">
    @csrf
    <div class="m-4 pagebox">
      <div class="row mt-4 mb-3">
        <label class="col-2 col-form-label text-end">卡密内容：</label>
        <div class="col-8">
          <div class="input-group">
            <input type="text" name="key" class="form-control" placeholder="点击右侧按钮可随机生成">
      ...
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end">
          <i class="iconfont iconfont-question" data-bs-toggle="tooltip" title="" data-bs-original-title="当卡密内容为空时，使用批量卡密的内容；以换行分割内容"></i>
          批量卡密：
        </label>
        <div class="col-8">
