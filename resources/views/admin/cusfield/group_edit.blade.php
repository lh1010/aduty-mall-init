...
<div class="main">
  <div class="bg-white p-4">
    <ol class="breadcrumb">
      <li class="breadcrumb-item">字段组</li>
  ...
  <form class="mt-4" id="form" action="/admin/cusfield/group_update" method="post" autocomplete="off">
    @csrf
    <input type="hidden" name="id" value="{{$group->id}}">
    <div class="m-4 pagebox">
      <div class="row mb-3">
        <label class="col-2 col-form-label text-end">名字：</label>
        <div class="col-8">
  ...
  submitHandler: function() {
    layer.confirm('确认提交？', function() {
      ...
      $("#form").ajaxSubmit(function(res) {
        layer.close(load);
        if (res.code == 200) {
          layer.msg('操作成功', { time: 1500 }, function () { window.location.href = '/admin/cusfield/group_list'; });
