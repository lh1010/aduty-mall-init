    ...
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/cusfield/create?group_id={{$group->id}}"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      <table class="table text-center mt-3">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/cusfield/edit?id={{$value->id}}">编辑</a>
...
function deleteAction(id = '') {
  ...
  layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/cusfield/delete?id=' + id,
      dataType: 'json',
