...
<div class="main">
  <div class="bg-white p-4">
    ...
    <div class="breadcrumb-stitle">文章分类</div>
  </div>
    ...
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/article/category_create"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      @if(!empty($categorys))
      <table class="table table-no-border text-center mt-3 categorys">
        <thead>
          <tr>
            <th width="30"></th>
            <th width="80">ID</th>
        ...
        <tbody>
          ...
          <tr class="group_{{$value->parent_id}}">
            ...
            <td class="name" style="text-align: left;">
              ...
              <a class="addchildboard iconfont" href="/admin/article/category_create?parent_id={{$value->id}}">添加子分类</a>
            </td>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/article/category_edit?id={{$value->id}}">编辑</a>
...
function deleteAction(id = '') {
  ...
  layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/article/category_delete?id=' + id,
      dataType: 'json',
