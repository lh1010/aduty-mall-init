...
<div class="main">
  <div class="bg-white p-4">
    ...
    <div class="breadcrumb-stitle">
      ...
      <span class="txt">新增文章</span>
    </div>
  </div>
  <ul class="form-message m-4 p-4"></ul>
  <form class="mt-4" id="form" action="/admin/article/store" method="post" autocomplete="off">
    @csrf
    <div class="m-4 pagebox">
      <div class="mt-4">
        ...
        <div class="row mb-3">
          ...
          <div class="col-8">
            <input class="form-control" name="shorttitle" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
          ...
          <div class="col-auto">
            <select class="form-select" name="category_id">
              ...
              <option value="{{$value->id}}">@php for($i = 1; $i < $value->level; $i++) {echo '&nbsp;&nbsp;';} @endphp {{$value->name}}</option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-2">
            <input class="form-control" name="click" value="0" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
