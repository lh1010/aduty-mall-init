...
<div class="main">
  <div class="bg-white p-4">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">新增广告</li>
    </ol>
    <div class="breadcrumb-stitle">
      <a href="javascript:history.go(-1);"><i class="iconfont goback"></i></a>
      <span class="txt">新增广告</span>
    </div>
  </div>

  <ul class="form-message m-4 p-4"></ul>
  <form class="mt-4" id="form" action="/admin/adver/store" method="post" autocomplete="off">
    @csrf
    <div class="m-4 pagebox">
      ...
      <div class="mt-4">
        ...
        <div class="row mb-3">
          <label class="col-2 col-form-label text-end"><i class="iconfont luck-icon-question" data-bs-toggle="tooltip" title="" data-bs-original-title="客户端使用，调取参数的唯一标识"></i> <span class="text-danger">*</span> Code：</label>
          <div class="col-8">
            ...
            <div class="item_box">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="open_modes[]">
                  <option value="1">新窗口打开/navigateTo模式</option>
                  <option value="2">当前页打开/switchTab模式</option>
                </select>
              </div>
              <div class="mb-3">
                <label class="form-label">广告排序</label>
                <input type="text" class="form-control" name="sorts[]">
              </div>
              <div class="">
  ...
  submitHandler: function() {
    layer.confirm('确认提交？', function() {
      ...
      $("#form").ajaxSubmit(function(res) {
        ...
        if (res.code == 200) {
          layer.msg('提交成功', { time: 1500 }, function () { window.location.href = '/admin/adver/list'; });
