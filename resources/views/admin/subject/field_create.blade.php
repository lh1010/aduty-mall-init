...
<div class="main">
  <div class="bg-white p-4">
    <div class="breadcrumb-stitle">
      ...
      <span class="txt">新增字段</span>
    </div>
    <div class="mt-3" style="font-size: 12px;">{{$subject->name}}</div>
  </div>

  <ul class="form-message m-4 p-4"></ul>
  <form class="mt-4" id="form" action="/admin/subject/field_store" method="post" autocomplete="off">
    @csrf
    ...
    <div class="m-4 pagebox">
      ...
      <div class="row mb-3">
        ...
        <div class="col-auto">
          <input class="form-control" name="key" placeholder="">
        </div>
      </div>
      @if(Request()->type == '文本')
      <div class="valuebox">
      ...
      <div class="valuebox">
        <div class="row mb-3">
          <label class="col-2 col-form-label text-end">内容：</label>
          <div class="col-8">
            <div id="editormd" class="editormd"><textarea name="value"></textarea></div>
          </div>
        </div>
      </div>
      @endif
...
$('select[name="type"]').change(function() {
  var url = '/admin/subject/field_create?subject_id={{$subject->id}}&type=' + $(this).val();
