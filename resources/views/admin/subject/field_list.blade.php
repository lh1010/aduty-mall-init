    ...
    <div class="pagebox">
      <div class="overflow-hidden">
        ...
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/subject/field_create?subject_id={{$subject->id}}&type=文本"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      <table class="table text-center mt-3">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/subject/field_edit?id={{$value->id}}&type={{$value->type}}">编辑</a>
      ...
      <div class="page my-3">{{ $fields->appends(Request()->all())->render() }}</div>
      @else
      <div class="noresult">
...
function deleteAction(id = '') {
  ...
  var layer_confirm = layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/subject/field_delete?id=' + id,
