...
<div class="main">
  <div class="bg-white p-4">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">新增专题</li>
    </ol>
    <div class="breadcrumb-stitle">
      <a href="javascript:history.go(-1);"><i class="iconfont goback"></i></a>
      <span class="txt">新增专题</span>
    </div>
  </div>
  
  <ul class="form-message m-4 p-4"></ul>
  <form class="mt-4" id="form" action="/admin/subject/store" method="post" autocomplete="off">
    @csrf
    ...
    <div class="m-4 pagebox">
      <div class="mt-4">
        ...
        <div class="row mb-3">
          ...
          <div class="col-auto">
            <input class="form-control" name="tpl_show" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-2">
            <input class="form-control" name="sort" value="" placeholder="">
          </div>
        </div>
        <div class="row mb-3">
