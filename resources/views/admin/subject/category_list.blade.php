...
<div class="main">
  <div class="bg-white p-4">
    ...
    <div class="breadcrumb-stitle">专题分类</div>
  </div>
  ...
  <div class="mx-4 mt-4">
    <div class="pagebox">
      <div class="overflow-hidden">
        <div class="float-start row g-2">
          <div class="col-auto" style="font-size: 12px; color: #999;">
            共有 {{$categorys->total()}} 条数据
          </div>
        </div>
        <div class="float-end row g-2">
          <div class="col-auto">
            <a class="btn btn-primary" href="/admin/subject/category_create"><i class="iconfont luck-icon-jia"></i> 新增</a>
          </div>
          <div class="col-auto">
      ...
      <table class="table table-no-border text-center mt-3 categorys">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary btn-sm" href="/admin/subject/category_edit?id={{$value->id}}">编辑</a>
      ...
      <div class="page my-3">{{ $categorys->appends(Request()->all())->render() }}</div>
      @else
      <div class="noresult">
...
function deleteAction(id = '') {
  ...
  layer.confirm('确认删除？', function(index) {
    ...
    $.ajax({
      type: 'GET',
      url: '/admin/subject/category_delete?id=' + id,
      dataType: 'json',
